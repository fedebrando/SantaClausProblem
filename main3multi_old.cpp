...
#define ELVES_MAX 15
#define N_REINDEER 9
#define N_EQ_AVG 10          // minimum number of average not-significantly variation to compute results for a single (n_elves, n_santa) couple
...
int main(void)
{
    double sum, sum_of_squared, avg, std_dev, old_avg;
    int num_values;
